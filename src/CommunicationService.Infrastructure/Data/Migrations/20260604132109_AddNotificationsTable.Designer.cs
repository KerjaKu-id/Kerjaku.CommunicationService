...
namespace CommunicationService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260604132109_AddNotificationsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommunicationService.Domain.Entities.ChatParticipant", b =>
                {
                    ...
                    b.Property<Guid>("ShadowUserId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ShadowUserId");

                    b.HasIndex("ChatRoomId", "ShadowUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CommunicationService.Domain.Entities.ChatRoom", b =>
                {
                    ...
                    b.Property<bool>("IsNegotiationActive")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("CommunicationService.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CommunicationService.Domain.Entities.ChatParticipant", b =>
                {
                    ...
                    b.HasOne("CommunicationService.Domain.Entities.UserShadow", "ShadowUser")
                        .WithMany()
                        .HasForeignKey("ShadowUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChatRoom");

                    b.Navigation("ShadowUser");
                });
            ...
            modelBuilder.Entity("CommunicationService.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("CommunicationService.Domain.Entities.UserShadow", "Sender")
                        .WithMany()
